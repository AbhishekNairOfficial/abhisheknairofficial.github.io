        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          <div>
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <a href="mailto:abhisheknr4@gmail.com" className="text-sm hover:text-emerald-400 transition-colors">
                  abhisheknr4@gmail.com
                </a>
              </div>
              <div className="flex items-center gap-2">
                <MapPin className="h-4 w-4 text-emerald-400" />
                <span className="text-sm">Bellevue, WA</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="https://github.com/abhisheknairofficial" target="_blank" className="p-2 border border-white hover:bg-white hover:text-black transition-all">
              ...
              <a href="https://linkedin.com/in/6foot4" target="_blank" className="p-2 border border-white hover:bg-white hover:text-black transition-all">
              <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
