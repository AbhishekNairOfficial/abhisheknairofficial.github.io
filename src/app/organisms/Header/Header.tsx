        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="hidden md:flex items-center justify-between py-0">
            ...
            <div className="flex items-center gap-3">
              ...
              <a href="https://github.com" className="hover:text-emerald-400 transition-colors" aria-label="GitHub">
                <svg className="h-3.5 w-3.5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto px-6 py-6">
        <div className="flex items-start justify-between">
          ...
          <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-black">
            <img src={"/images/profile-picture.jpg"} alt="Profile" className="w-full h-full object-cover" />
          </div>
        </div>
      </div>
    </header>
